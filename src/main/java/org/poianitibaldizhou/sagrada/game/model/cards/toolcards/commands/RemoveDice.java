...
public class RemoveDice implements ICommand {
    ...
    public ObjectiveCardType getConstraintType() {
        return constraintType;
    }

    private final ObjectiveCardType constraintType;

    public RemoveDice(ObjectiveCardType type) {
     ...
     * So it requires a color in constraintType == ObjectiveCardType.COLOR.
    ...
    public boolean executeCommand(Player player, ToolCardExecutorHelper toolCardExecutorHelper, Game game) throws RemoteException, InterruptedException {
        ...
        do {
            if (this.constraintType == ObjectiveCardType.COLOR) {
                do {
