...
public class PositionTest {
    ...
    public PositionTest(boolean expected, Position p1, Position p2) {
    ...
    public void testFailConstructor() throws IllegalAccessException {
        Position position = new Position(-1, 5);
    }

    @Test(expected = Exception.class)
    public void testFailEquals() throws Exception {
        assertNotEquals(position1, new ArrayList<>());
    }
}
